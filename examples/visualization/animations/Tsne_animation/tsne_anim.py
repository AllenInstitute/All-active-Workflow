...
def tsne_embedding_simple(param_df,hue="Cre_line", 
            figname = 'tsne_%s.pdf'%np.random.randn(), 
            figtitle = '',drop_apical = False,
            force_hue = False,
            col_var = 'Layer',
...
max_hof_index = 40
filter_feat = 'Dendrite_type'; filter_val = 'aspiny'
...
for hof_ind in range(max_hof_index):
    ...
    tsne_embedding_simple(mouse_data_hof,hue="Cre_line", 
            figname = file_path, 
            col_var = 'Species',
