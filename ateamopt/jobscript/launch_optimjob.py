...
def create_optim_job(args):
    ...
    if len(cell_metadata_path) == 0:
        ...
        optim_proc.save_morph_data(cell_metadata)
    ...
    stage_level_jobconfig_path = os.path.join(stage_jobdir,'stage_job_config.json')
    ...
    analyze_jobscript_default=utility.locate_script_file('analyze_stagejob.py')
