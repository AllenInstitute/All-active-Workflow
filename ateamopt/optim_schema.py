...
class Stage_JobConfig(ags.schemas.DefaultSchema):
    ...
    filter_rule = ags.fields.Str(
        description="Name of stim selection function in optim_config_rules")
    ...
    depol_block_check = ags.fields.Boolean(description="", default=True)
